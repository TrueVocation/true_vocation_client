...
const Home = () => {
    ...
    const animationBottomToTopThenHover = {
        visible: {y: 0, transition: {duration: 0.53}}, hidden: {y: 20},
    }
    ...
    // const universities = [{
    //     name: "Al-Farabi Kazakh Natinal University",
    ...
    //     description: "Al-Farabi Kazakh National University (kaz. Al-Farabi atyndagi Kazak ulttyk universitet) is a leading multidisciplinary higher education institution in Kazakhstan.",
    //     city: "Almaty",
    //     address: "71 Al-Farabi Avenue, Almaty"
    // },
    //
    //     {
    //         name: "Kazakh British Technical University",
    //         image: "https://kbtu.edu.kz/images/logo_stzh.jpg",
    //         description: "Kazakh-British Technical University JSC is a scientific and educational cluster that unites the university, it was created to ensure the interconnection of innovative, research and educational blocks, as well as the real integration of science, education and production.",
    //         city: "Almaty",
    //         address: "59 Tole Bi Street, Almaty"
    //     },
    //
    //     {
    ...
    //         description: "The International University of Information Technologies was established in April 2009 on behalf of the President of the Republic of Kazakhstan, in cooperation with the educational organization iCarnegie, representing the American IT University Carnegie Mellon University.",
    //         city: "Almaty",
    //         address: "8 Manas Street, Almaty"
    //     },
    //
    //     {
    //         name: "Kazakh Humanitarian Law University",
    //         image: "https://asu.edu.ru/images/Image/KAzGYuU.jpg",
    //         description: "M.S. Narikbayev KAZGUU University (formerly Kazakh Humanitarian Law University) (kaz. M.S. Narikbayev atyndagi KAZGUU Universities), (eng. M. Narikbayev KAZGUU University) is a higher educational institution located in Nur-Sultan and established in 1994.",
    //         city: "Almaty",
    //         address: "Korgalzhinskoe sh. 8, Nursultan"
    //     },
    //
    //     {
    //         name: "Kazakh British Technical University",
    ...
    return (<Box sx={{display: "flex", flexDirection: "column",backgroundColor:"rgb(242, 245, 249)"}} >
        <motion.div
            initial={"hidden"}
            whileInView={"visible"}
                ...
                <Grid container xs={12} sm={12} md={12} lg={12} xl={12} item justifyContent={"center"} flexDirection={"column"} alignContent={"center"}>
                    <CustomAnimatedComponent variants={animationBottomToTop} custom={1}>
                        <Typography variant={"h5"} fontFamily={"Inter"} textAlign={"center"}
                                    style={{
                                        color: "#FFC107", marginTop: 20, fontSize: 17, fontWeight: "bold"
                                    }}>NUMBERS</Typography>
                    </CustomAnimatedComponent>
                    <CustomAnimatedComponent variants={animationBottomToTop} custom={2}>
                        <Typography variant={"h5"} fontFamily={"Inter"} textAlign={"center"}
                                    style={{color: "#2d3e4a", marginTop: 5, fontWeight: "bold", fontSize: 30}}>
                            Our information and statistics are available to everyone
                        </Typography>
                    </CustomAnimatedComponent>
                    <CustomAnimatedComponent variants={animationBottomToTop} custom={3}>
                        <Typography variant={"h6"} fontFamily={"Inter"} textAlign={"center"}
                                    style={{color: "rgb(103, 119, 136)", marginTop: 5}}>
                            The best way to choose is to first do an analysis.
                            <br/> That's why we have all the necessary information for you to make the right,
                            balanced and informed choice of your future.
                        </Typography>
                    </CustomAnimatedComponent>
                    <CustomAnimatedComponent variants={animationBottomToTop} custom={4}>
                        <Grid container item justifyContent={"center"} style={{marginTop: 15}}>
                            <Button size={"large"} variant={"outlined"}
                                    id={"primary_button_outlined"}>Specialties</Button>
                            <Button size={"large"} variant={"contained"} id={"primary_button"}
                                    style={{marginLeft: 15}}>Sought-after professions</Button>
                        </Grid>
                    </CustomAnimatedComponent>
                </Grid>
                                ...
                                <Box flexDirection={"column"}>
                                    ...
                                    <Typography variant={"h4"} fontFamily={"Inter"}
                                        ...
                                        <ReactVisibilitySensor partialVisibility offset={{bottom: 8}}>
                                            {({isVisible}) => (<div style={{height: 38}}>
                                                {isVisible ? <CountUp delay={0.5} end={2000}/> : null}+
                                            </div>)}
                                        </ReactVisibilitySensor>
                                    </Typography>
                                    <Typography variant={"h6"} fontFamily={"Inter"}
                                                style={{
                                                    color: "#2d3e4a", fontSize: 25, marginBottom: 10
                                                }}>Professions</Typography>
                                    <Typography variant={"body1"} fontFamily={"Inter"}
                                                style={{color: "rgb(103, 119, 136)", fontSize: 18}}>
                                        Information about professions and their relevance
                                    </Typography>
                                </Box>
                            </Paper>
                        </CustomAnimatedComponent>
                            ...
                            <Paper variant={"outlined"}
                                ...
                                <Box flexDirection={"column"}>
                                    <Avatar variant={"circular"} style={{
                                        ...
                                        <ReactVisibilitySensor partialVisibility offset={{bottom: 8}}>
                                            {({isVisible}) => (<div style={{height: 38}}>
                                                {isVisible ? <CountUp delay={0.5} end={130}/> : null}+
                                            </div>)}
                                        </ReactVisibilitySensor>
                                    </Typography>
                                    <Typography variant={"h6"} fontFamily={"Inter"}
                                                style={{color: "#2d3e4a", fontSize: 25, marginBottom: 10}}>
                                        Universities
                                    </Typography>
                                    <Typography variant={"body1"} fontFamily={"Inter"}
                                                style={{color: "rgb(103, 119, 136)", fontSize: 18}}>
                                        Full information about universities and its program
                                    </Typography>
                                </Box>
                            </Paper>
                            ...
                            <Paper variant={"outlined"}
                                ...
                                <Box flexDirection={"column"}>
                                    ...
                                    <Typography variant={"h4"} fontFamily={"Inter"}
                                        ...
                                        <ReactVisibilitySensor partialVisibility offset={{bottom: 8}}>
                                            {({isVisible}) => (<div style={{height: 38}}>
                                                {isVisible ? <CountUp delay={0.5} end={4000}/> : null}+
                                            </div>)}
                                        </ReactVisibilitySensor>
                                    </Typography>
                                    <Typography variant={"h6"} fontFamily={"Inter"}
                                    ...
                                    <Typography variant={"body1"} fontFamily={"Inter"}
                                                style={{color: "rgb(103, 119, 136)", fontSize: 18}}>
                                        Sought-after specialties and its educational programs
                                    </Typography>
                                </Box>
                            </Paper>
                            ...
                            <Paper variant={"outlined"}
                                ...
                                <Box flexDirection={"column"}>
                                    ...
                                    <Typography variant={"h4"} fontFamily={"Inter"}
                                        ...
                                        <ReactVisibilitySensor partialVisibility offset={{bottom: 8}}>
                                            {({isVisible}) => (<div style={{height: 38}}>
                                                {isVisible ? <CountUp delay={0.5} end={500}/> : null}+
                                            </div>)}
                                        </ReactVisibilitySensor>
                                    </Typography>
                                    <Typography variant={"h6"} fontFamily={"Inter"}
                                    ...
                                    <Typography variant={"body1"} fontFamily={"Inter"}
                                                style={{color: "rgb(103, 119, 136)", fontSize: 18}}>
                                        Information about courses available in Kazakhstan by specialty and not only
                                    </Typography>
                                </Box>
                            </Paper>
                        </CustomAnimatedComponent>
                ...
                <Grid container item xs={12} sm={12} md={12} lg={12} xl={12} justifyContent={"center"} flexDirection={"column"} alignContent={"center"}>
                    ...
                    <CustomAnimatedComponent variants={animationText} custom={2}>
                        <Typography variant={"h5"} fontFamily={"Inter"} textAlign={"center"}
                            ...
                            your specialty by subject</Typography>
                    </CustomAnimatedComponent>
                    <CustomAnimatedComponent variants={animationTextRightToLeft} custom={3}>
                        <Typography variant={"h6"} fontFamily={"Inter"} textAlign={"center"}
                                    style={{color: "rgb(103, 119, 136)", marginTop: 5}}>
                            Choose a subject and find out what educational programs, specialties and professions
                            there are in the subject
                        </Typography>
                    </CustomAnimatedComponent>
                    <CustomAnimatedComponent variants={animationTextRightToLeft} custom={4}>
                        <Grid container item justifyContent={"center"} style={{marginTop: 15}}>
                            <Button size={"large"} variant={"outlined"} id={"primary_button_outlined"}>Choose
                                now</Button>
                            <Button size={"large"} onClick={() => navigate("/subjects", true)} variant={"contained"}
                                    id={"primary_button"}
                                    style={{marginLeft: 15}}>All subjects</Button>
                        </Grid>
                    </CustomAnimatedComponent>
                </Grid>
                ...
                <Grid container item xs={12} sm={12} md={12} lg={12} xl={12} justifyContent={"center"} flexDirection={"column"} alignContent={"center"}>
                    <CustomAnimatedComponent variants={animationText} custom={1}>
                        <Typography variant={"h5"} fontFamily={"Inter"} textAlign={"center"}
                                    style={{
                                        color: "#FFC107", marginTop: 20, fontSize: 17, fontWeight: "bold"
                                    }}>Universities</Typography>
                    </CustomAnimatedComponent>
                    <CustomAnimatedComponent variants={animationText} custom={2}>
                        <Typography variant={"h5"} fontFamily={"Inter"} textAlign={"center"}
                                    style={{color: "#2d3e4a", marginTop: 5, fontWeight: "bold", fontSize: 30}}>Browse
                            all popular universities</Typography>
                    </CustomAnimatedComponent>
                    <CustomAnimatedComponent variants={animationTextRightToLeft} custom={3}>
                        <Typography variant={"h6"} fontFamily={"Inter"} textAlign={"center"}
                                    style={{color: "rgb(103, 119, 136)", marginTop: 5}}>
                            Here are described all the universities of Kazakhstan in one of which you would like to
                            study
                        </Typography>
                    </CustomAnimatedComponent>
                    <CustomAnimatedComponent variants={animationTextRightToLeft} custom={4}>
                                ...
                                <Grid container justifyContent={"center"} item xs={12} sm={10} md={6} lg={6} xl={4}>
                                    <TextField style={{width:"100%"}} {...register("login", {
                                        required: 'Login field is required', minLength: {
                                            ...
                                            value: 50, message: "length must be less than 50 character"
                                        }
